...
model_options = {'K Nearest Neighbors' : KNNClassifier(k = 5, normDistance = 2, proba = True, threshold = 0.7),
                 'Neural Network' : NeuralNetClassifier(n_hidden = 10, learning_rate = 0.001, n_iters = 1000, proba = True, threshold = 0.6),
                 'Random Forest' : RandomForestClassifier(n_estimators = 10, max_depth = 10, min_samples_split = 2, proba = True, threshold = 0.6),
